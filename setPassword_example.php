...
// After successful password updation on your website, assign the user information to $user array to set the password at the chat room.
...
// function called for setting the password on chat room.
